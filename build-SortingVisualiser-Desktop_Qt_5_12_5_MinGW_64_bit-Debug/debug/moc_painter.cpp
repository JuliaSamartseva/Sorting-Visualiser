...
#include "../../SortingVisualiser/painter.h"
...
QT_MOC_LITERAL(1, 8, 14), // "NumbersChanged"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 16) // "std::vector<int>"

    },
    "Painter\0NumbersChanged\0\0std::vector<int>"
};
...
void Painter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Painter::*)(std::vector<int> , std::vector<int> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Painter::NumbersChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Painter::NumbersChanged(std::vector<int> _t1, std::vector<int> _t2)
{
